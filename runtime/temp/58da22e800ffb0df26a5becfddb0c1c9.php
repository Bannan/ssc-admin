<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"C:\Users\null\Desktop\www\ssc\public/../application/common\view\tpl\dispatch_jump.tpl";i:1523974191;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="system-message <?php echo $codeText; ?>">
            <div class="image">
                <img src="/ssc/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo $msg; ?></h1>
            <p class="jump">
